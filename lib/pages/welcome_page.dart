...
import '../widgets/getin_glowing_button.dart';
                    ...
                    children: [
                      ...
                      index == (images.length - 1)
                          ...
                          GestureDetector(
                              ...
                              // },
                              child: GetInGlowingButton(
                                color1: Color.fromARGB(255, 87, 6, 104),
                                color2: Color.fromARGB(255, 5, 12, 110),
                                callback: () {
                                  Get.to(() => SpinAnimation());
                                  Get.off(() => HomePage(),
                                      duration: Duration(seconds: 2));
